...
@Component({
  selector: 'app-table-dine-in',
  templateUrl: './table-dine-in.component.html',
  styleUrl: './table-dine-in.component.css'
})
export class TableDineInComponent {
  ...
  updateDailog(data: Recipe, isSum: boolean) {
    ...
    this.dialog
      .open(TableDineInComponent, dialogConfig)
      .afterClosed()
      .subscribe((result) => {
        this.getAll();
      });
